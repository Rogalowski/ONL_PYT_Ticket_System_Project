...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/mnt/WindowsDaneNTFS/Programowanie/ONL_PYT_Ticket_System_Project/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/mnt/WindowsDaneNTFS/Programowanie/ONL_PYT_Ticket_System_Project/venv/bin/deactivate.nu'
