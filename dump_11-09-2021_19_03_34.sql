...
COPY public.ticket_app_user (id, password, last_login, is_superuser, username, first_name, last_name, email, is_staff, is_active, date_joined, address_city, phone_number, department_id) FROM stdin;
5	pbkdf2_sha256$260000$f8c3oXeiUbUmP8PjjHFDpC$0if/IPzOy3FmrmOKrZ6Y1GDpvsj6DOlwDznEgNtvOiQ=	\N	f	fb_ania	Ania	FB_Surname	fb@admin.com	t	t	2021-09-04 10:23:37.824659+00	Szczecin	444444444	5
2	pbkdf2_sha256$260000$f8c3oXeiUbUmP8PjjHFDpC$0if/IPzOy3FmrmOKrZ6Y1GDpvsj6DOlwDznEgNtvOiQ=	\N	f	hr_kasia	Kasia	HR_Surname	hr@admin.com	t	t	2021-09-04 10:23:37.824659+00	Szczecin	222222222	3
3	pbkdf2_sha256$260000$f8c3oXeiUbUmP8PjjHFDpC$0if/IPzOy3FmrmOKrZ6Y1GDpvsj6DOlwDznEgNtvOiQ=	\N	f	pm_andrzej	Andrzej	PM_Surname	pm@admin.com	t	t	2021-09-04 10:23:37.824659+00	Szczecin	333333333	4
7	pbkdf2_sha256$260000$f8c3oXeiUbUmP8PjjHFDpC$0if/IPzOy3FmrmOKrZ6Y1GDpvsj6DOlwDznEgNtvOiQ=	\N	f	hr_magda	Magda	HR_Surname	hr@admin.com	t	t	2021-09-04 10:23:37.824659+00	Szczecin	222222222	3
8	pbkdf2_sha256$260000$f8c3oXeiUbUmP8PjjHFDpC$0if/IPzOy3FmrmOKrZ6Y1GDpvsj6DOlwDznEgNtvOiQ=	\N	f	pm_kacper	Kacper	PM_Surname	pm@admin.com	t	t	2021-09-04 10:23:37.824659+00	Szczecin	333333333	4
9	pbkdf2_sha256$260000$f8c3oXeiUbUmP8PjjHFDpC$0if/IPzOy3FmrmOKrZ6Y1GDpvsj6DOlwDznEgNtvOiQ=	\N	f	fb_paweł	Paweł	FB_Surname	fb@admin.com	t	t	2021-09-04 10:23:37.824659+00	Szczecin	444444444	5
10	pbkdf2_sha256$260000$f8c3oXeiUbUmP8PjjHFDpC$0if/IPzOy3FmrmOKrZ6Y1GDpvsj6DOlwDznEgNtvOiQ=	\N	f	it_krzysztof	Krzysztof	IT_Surname	it@admin.com	t	t	2021-09-04 10:23:37.824659+00	Szczecin	111111111	2
11	pbkdf2_sha256$260000$f8c3oXeiUbUmP8PjjHFDpC$0if/IPzOy3FmrmOKrZ6Y1GDpvsj6DOlwDznEgNtvOiQ=	\N	f	hr_paulina	Paulina	HR_Surname	hr@admin.com	t	t	2021-09-04 10:23:37.824659+00	Szczecin	222222222	3
12	pbkdf2_sha256$260000$f8c3oXeiUbUmP8PjjHFDpC$0if/IPzOy3FmrmOKrZ6Y1GDpvsj6DOlwDznEgNtvOiQ=	\N	f	pm_grzegorz	Grzegorz	PM_Surname	pm@admin.com	t	t	2021-09-04 10:23:37.824659+00	Szczecin	333333333	4
4	pbkdf2_sha256$260000$f8c3oXeiUbUmP8PjjHFDpC$0if/IPzOy3FmrmOKrZ6Y1GDpvsj6DOlwDznEgNtvOiQ=	2021-09-11 14:31:39.736769+00	t	admin			admin@admin.com	t	t	2021-09-04 10:23:37.824659+00	N/A	0	1
6	pbkdf2_sha256$260000$f8c3oXeiUbUmP8PjjHFDpC$0if/IPzOy3FmrmOKrZ6Y1GDpvsj6DOlwDznEgNtvOiQ=	2021-09-11 16:50:28.801229+00	f	it_jacek	Jacek	IT_Surname	it@admin.com	t	t	2021-09-04 10:23:37.824659+00	Szczecin	111111111	2
1	pbkdf2_sha256$260000$f8c3oXeiUbUmP8PjjHFDpC$0if/IPzOy3FmrmOKrZ6Y1GDpvsj6DOlwDznEgNtvOiQ=	2021-09-11 16:54:32.823414+00	f	it_bartek	InforName	IT_Surname	it@admin.com	t	t	2021-09-04 10:23:37.824659+00	Szczecin	111111111	2
\.
...
SELECT pg_catalog.setval('public.ticket_app_department_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.ticket_app_user_id_seq', 4, true);
...
--
-- Name: django_admin_log django_admin_log_user_id_c564eba6_fk_ticket_app_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.django_admin_log
    ADD CONSTRAINT django_admin_log_user_id_c564eba6_fk_ticket_app_user_id FOREIGN KEY (user_id) REFERENCES public.ticket_app_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: ticket_app_correspondence ticket_app_correspon_ticket_correspondenc_dab7194b_fk_ticket_ap; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_app_correspondence
    ADD CONSTRAINT ticket_app_correspon_ticket_correspondenc_dab7194b_fk_ticket_ap FOREIGN KEY (ticket_correspondence_id) REFERENCES public.ticket_app_ticket(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: ticket_app_correspondence ticket_app_correspon_user_id_fe0ea71e_fk_ticket_ap; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_app_correspondence
    ADD CONSTRAINT ticket_app_correspon_user_id_fe0ea71e_fk_ticket_ap FOREIGN KEY (user_id) REFERENCES public.ticket_app_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: ticket_app_departmentproblem ticket_app_departmen_department_id_e194d448_fk_ticket_ap; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_app_departmentproblem
    ADD CONSTRAINT ticket_app_departmen_department_id_e194d448_fk_ticket_ap FOREIGN KEY (department_id) REFERENCES public.ticket_app_department(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: ticket_app_ticket ticket_app_ticket_department_assignmen_7a607196_fk_ticket_ap; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_app_ticket
    ADD CONSTRAINT ticket_app_ticket_department_assignmen_7a607196_fk_ticket_ap FOREIGN KEY (department_assignment_id) REFERENCES public.ticket_app_department(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: ticket_app_ticket ticket_app_ticket_problem_category_id_bf798beb_fk_ticket_ap; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_app_ticket
    ADD CONSTRAINT ticket_app_ticket_problem_category_id_bf798beb_fk_ticket_ap FOREIGN KEY (problem_category_id) REFERENCES public.ticket_app_departmentproblem(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: ticket_app_ticket_user_assignment ticket_app_ticket_us_ticket_id_b99e2cd4_fk_ticket_ap; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_app_ticket_user_assignment
    ADD CONSTRAINT ticket_app_ticket_us_ticket_id_b99e2cd4_fk_ticket_ap FOREIGN KEY (ticket_id) REFERENCES public.ticket_app_ticket(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: ticket_app_ticket_user_assignment ticket_app_ticket_us_user_id_2b125c5f_fk_ticket_ap; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_app_ticket_user_assignment
    ADD CONSTRAINT ticket_app_ticket_us_user_id_2b125c5f_fk_ticket_ap FOREIGN KEY (user_id) REFERENCES public.ticket_app_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: ticket_app_ticket ticket_app_ticket_user_requestor_id_aef8bf5d_fk_ticket_ap; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_app_ticket
    ADD CONSTRAINT ticket_app_ticket_user_requestor_id_aef8bf5d_fk_ticket_ap FOREIGN KEY (user_requestor_id) REFERENCES public.ticket_app_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: ticket_app_user ticket_app_user_department_id_e394c7c2_fk_ticket_ap; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_app_user
    ADD CONSTRAINT ticket_app_user_department_id_e394c7c2_fk_ticket_ap FOREIGN KEY (department_id) REFERENCES public.ticket_app_department(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: ticket_app_user_groups ticket_app_user_groups_user_id_e7ba3fa7_fk_ticket_app_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_app_user_groups
    ADD CONSTRAINT ticket_app_user_groups_user_id_e7ba3fa7_fk_ticket_app_user_id FOREIGN KEY (user_id) REFERENCES public.ticket_app_user(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: ticket_app_user_user_permissions ticket_app_user_user_user_id_aa0d73cf_fk_ticket_ap; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_app_user_user_permissions
    ADD CONSTRAINT ticket_app_user_user_user_id_aa0d73cf_fk_ticket_ap FOREIGN KEY (user_id) REFERENCES public.ticket_app_user(id) DEFERRABLE INITIALLY DEFERRED;
